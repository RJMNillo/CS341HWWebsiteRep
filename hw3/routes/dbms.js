 ...
 */
 ...
 var host = "35.227.167.47";    //from GCloud instance (change to match your db)
 var database = "CHEESECAKE";  //database name
 var user = "prefab-pixel-305001:us-west1:cheesecake-db";         //username (change to match your db)
 var password = "#yperDrive01";  //password (change to match your db, yes this is very poor practice)
 //Having George share a database with me, as the shut down of my project also suspended my sql server and 
 //Google won't let me make a new mysql instance
 //UPDATE: I was able to create a new one
